...
| `voice_embeddings:read` | `POST /api/v1/people/identify`, `POST /api/v1/people/verify`, `GET /api/v1/people/{id}/embeddings` — required for all biometric data reads |
