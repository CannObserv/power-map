...
async def activity_index(
    ...
    # Single round trip; the LATERAL yields the busiest key of the last 24h
    # (#294) so a runaway client is visible from the landing page, not only
    # after drilling into the request log. busiest_* are NULL when there was
    ...
    counts = await db.fetchrow(
        ...
        SELECT
            ...
            b.key_label AS busiest_key_label,
            b.request_count AS busiest_request_count
        FROM (SELECT 1) AS _
        LEFT JOIN LATERAL (
